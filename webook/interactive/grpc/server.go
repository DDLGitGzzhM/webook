...
// InteractiveServiceServer 把 service 包装成 grpc
// 和 grpc 有关的操作，就限定在这里
...
func (i *InteractiveServiceServer) IncrReadCnt(
	ctx context.Context, request *intrv1.IncrReadCntRequest,
...
func (i *InteractiveServiceServer) Like(
	ctx context.Context, request *intrv1.LikeRequest,
...
func (i *InteractiveServiceServer) CancelLike(
	ctx context.Context, request *intrv1.CancelLikeRequest,
...
func (i *InteractiveServiceServer) Collect(
	ctx context.Context, request *intrv1.CollectRequest,
...
func (i *InteractiveServiceServer) Get(
	ctx context.Context, request *intrv1.GetRequest,
...
func (i *InteractiveServiceServer) GetByIds(
	ctx context.Context, request *intrv1.GetByIdsRequest,
