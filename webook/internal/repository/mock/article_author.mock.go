...
//
//	mockgen -source=webook/internal/repository/article/article_author.go -package=repomocks -destination=webook/internal/repository/mock/article_author.mock.go
//
