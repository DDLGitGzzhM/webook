...
//
//	mockgen -source=webook/internal/repository/article/article_reader.go -package=repomocks -destination=webook/internal/repository/mock/article_reader.mock.go
//
...
func (m *MockArticleReaderRepository) UpdateById(ctx context.Context, art domain.Article) error {
	m.ctrl.T.Helper()
...
func (mr *MockArticleReaderRepositoryMockRecorder) UpdateById(ctx, art any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateById", reflect.TypeOf((*MockArticleReaderRepository)(nil).UpdateById), ctx, art)
}
