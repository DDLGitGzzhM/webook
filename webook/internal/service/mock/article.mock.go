...
func (mr *MockIArticleServiceMockRecorder) GetPublishedById(ctx, id, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIArticleServiceMockRecorder) ListPub(ctx, start, offset, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
